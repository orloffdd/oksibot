...
async def extract_columns(filename = "xlsx/elements.xlsx"):

    df = pd.read_excel(filename)
    columns_to_extract = [8, 9, 10, 11, 12, 13, 14, 15, 19]
    selected_data = df.iloc[:, columns_to_extract]
